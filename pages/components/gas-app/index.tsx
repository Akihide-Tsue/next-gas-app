  ...
  return (
    <>
      ...
      <div className={classes.container}>
        <div>Propsで受け取った初期値：{dev.textbox}</div>
        <div>fetchAPIで取得したnext.jsの星の数：{stars}</div>
        <div>axiosAPIで取得したarchived：{`${archived}`}</div>
        <div>axiosAPIで取得したdescription：{description}</div>
        <div>
          <BadDispatchCounter />
        </div>
        <div>
